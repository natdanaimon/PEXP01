		                                                ...
		                                                <div class="form-group m-form__group row">
		                                                    ...
		                                                    <div class="col-md-8">
		                                                        ...
		                                                        <div id="image-preview">
		                                                            ...
		                                                            <input  type="file" name="s_product" id="s_product" onchange="readURL(this,'blah-s_product');" accept="image/*"  />
		                                                        </div>
		                                                    </div>
		                                                </div>
	                                                </div>
		                                              	...
		                                              	<div class="form-group m-form__group row">
		                                                    ...
		                                                    <div class="col-md-8">
		                                                        ...
		                                                        <div id="image-preview">
		                                                            ...
		                                                            <input  type="file" name="s_slip" id="s_slip" onchange="readURL(this,'blah-s_slip');" accept="image/*"  />
		                                                        </div>
		                                                    </div>
		                                                </div>
	                                                </div>
